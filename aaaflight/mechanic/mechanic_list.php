...
$query_rs = "SELECT u.* FROM `user` u WHERE `group`='Mechanic' ORDER BY u.`lastname`, firstname, middlename";
$db->query($query_rs);
$rs=$db->rowset();
...
<div class="modal fade" id="modalDialogPrint" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body"><div id="printArea"><?php require('mechanic_print.php'); ?></div></div>
