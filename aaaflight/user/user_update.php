...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
	  ...
	  $SQLcrud = "UPDATE user SET `firstname`=?, `middlename`=?, `lastname`=?, `extname`=?, `date_of_birth`=?, `age`=?, `place_of_birth`=?, `nationality`=?, `gender`=?, `contact_no`=?, `address`=?, `blood_type`=?, `contact_person`=?, `contact_person_no`=?, `designation`=?, `username`=?, `fil`=?, `cpl`=?, `ntc`=?, `medl`=?, `elp`=?, `mecl`=?, `password`=?, `group`=?, `status`=?, required_hours=? WHERE id=?";
		$db->query($SQLcrud);
    ...
    $db->bind(25,htmlentities($_POST['status']));
    $db->bind(26,htmlentities($_POST['required_hours']));
		$db->bind(27,htmlentities($_POST['id']));
		$db->execute();
...
$db->query($query_rs);
$db->bind(1,htmlentities($recordID));
$row_rs = $db->rowsingle();
...
<form  method="POST" name="form1" id="form1" onsubmit="return validateForm();" enctype="multipart/form-data">
       ...
       <br>
        <div class="row">
          ...
          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input required type="text" class="form-control" name="firstname" id="firstname" placeholder=" " value="<?php echo htmlentities($row_rs['firstname']); ?>"><label >First Name*</label></div>
          </div>

          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input type="text" class="form-control" name="middlename" id="middlename" placeholder=" " value="<?php echo htmlentities($row_rs['middlename']); ?>"><label >Middle Name</label></div>
          </div>

          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input required type="text" class="form-control" name="lastname" id="lastname" placeholder=" " value="<?php echo htmlentities($row_rs['lastname']); ?>"><label >Last Name*</label></div>
          </div>

          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input type="text" class="form-control" name="extname" id="extname" placeholder=" " value="<?php echo htmlentities($row_rs['extname']); ?>"><label >Ext. Name</label></div>
          </div>

          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input required type="date" class="form-control" name="date_of_birth" id="date_of_birth" placeholder=" " value="<?php echo htmlentities($row_rs['date_of_birth']); ?>" onblur="calculateAge();" onclick="calculateAge();"><label >Date of Birth*</label></div>
          </div>
          ...
          <div class="form-group col-md-6 col-sm-12">
            <div class="form-floating"><input required type="text" class="form-control" name="place_of_birth" id="place_of_birth" placeholder=" " value="<?php echo htmlentities($row_rs['place_of_birth']); ?>"><label >Place of Birth*</label></div>
          </div>

          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input required type="text" class="form-control" name="nationality" id="nationality" placeholder=" " value="<?php echo htmlentities($row_rs['nationality']); ?>"><label >Nationality*</label></div>
          </div>
          ...
          <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating">
                    <select name="gender" id="gender" class="form-select" placeholder="">
                          ...
                          <option value="male" <?php if (!(strcmp('male', $row_rs['gender']))) {echo "selected=\"selected\"";} ?>>male</option>
                          <option value="female" <?php if (!(strcmp('female', $row_rs['gender']))) {echo "selected=\"selected\"";} ?>>female</option>
                          <option value="LGBTQ" <?php if (!(strcmp('LGBTQ', $row_rs['gender']))) {echo "selected=\"selected\"";} ?>>LGBTQ</option>
                    </select>
                    <label>Gender*</label>
                </div>
          ...
          <div class="form-group col-md-2 col-sm-12">
            <div class="form-floating"><input type="text" class="form-control" name="contact_no" id="contact_no" placeholder=" " value="<?php echo htmlentities($row_rs['contact_no']); ?>"><label >Contact No*</label></div>
          </div>
        ...
        <br>
            ...
            <div class="form-floating">
              <select required name="designation" id="designation" class="form-select" placeholder=" ">
                <?php
                  ...
                  ?>
                    <option value="<?php echo htmlentities($row_rsdesignation['designation'])?>"<?php if (!(strcmp($row_rsdesignation['designation'], $row_rs['designation']))) {echo "selected=\"selected\"";} ?>><?php echo htmlentities($row_rsdesignation['designation']);?></option>
                  <?php
                    }
                  ?>
                </select>
          ...
          <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating">
                    <select name="blood_type" id="blood_type" class="form-select" placeholder="">
                      <option value="" <?php if (!(strcmp('', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>></option>
                      <option value="A+" <?php if (!(strcmp('A+', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>A+</option>
                      <option value="B+" <?php if (!(strcmp('B+', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>B+</option>
                      <option value="O+" <?php if (!(strcmp('O+', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>O+</option>
                      <option value="AB+" <?php if (!(strcmp('AB+', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>AB+</option>
                      <option value="A-" <?php if (!(strcmp('A-', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>A-</option>
                      <option value="B-" <?php if (!(strcmp('B-', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>B-</option>
                      <option value="O-" <?php if (!(strcmp('O-', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>O-</option>
                      <option value="AB-" <?php if (!(strcmp('AB-', $row_rs['blood_type']))) {echo "selected=\"selected\"";} ?>>AB-</option>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-2 col-sm-12">
                  <div class="form-floating">
                      ...
                      foreach($rsgroup as $row_rsgroup) {  
                        ?>
                            <option value="<?php echo htmlentities($row_rsgroup['group'])?>"
                            <?php if (!(strcmp(htmlentities($row_rsgroup['group']), htmlentities($row_rs['group'])))){echo "selected=\"selected\"";}?>><?php echo htmlentities($row_rsgroup['group']);?></option>
                            <?php
                          }
                        ?>
                      </select>
            ...
            <div class="form-group col-md-2 col-sm-12">
                  <div class="form-floating">
                      <select name="status" class="form-select "  placeholder=" ">
                            ...
                            <option value="active" <?php if (!strcmp('active',htmlentities($row_rs['status']))) { echo "selected=\"selected\""; } ?>>active</option>
                            <option value="disabled" <?php if (!strcmp('disabled',htmlentities($row_rs['status']))) { echo "selected=\"selected\""; } ?>>disabled</option>
            ...
            <div class="row">      
              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="fil" id="fil" placeholder=" " value="<?php echo htmlentities($row_rs['fil']); ?>"
                ><label >Flight Instructor License</label></div>
              </div>

              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="cpl" id="cpl" placeholder=" " value="<?php echo htmlentities($row_rs['cpl']); ?>"
                ><label >Commercial Pilot License</label></div>
              </div>

              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="ntc" id="ntc" placeholder=" " value="<?php echo htmlentities($row_rs['ntc']); ?>"
                ><label >NTC </label></div>
              </div>

              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="medl" id="medl" placeholder=" " value="<?php echo htmlentities($row_rs['medl']); ?>"
                ><label >Medical License</label></div>
              </div>

              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="elp" id="elp" placeholder=" " value="<?php echo htmlentities($row_rs['elp']); ?>"
                ><label >English Proficiency License</label></div>
              </div>

              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="date" class="form-control" name="mecl" id="mecl" placeholder=" " value="<?php echo htmlentities($row_rs['mecl']); ?>"
          ...
          <div class="row">      
              <div class="form-group col-md-2 col-sm-12">
                <div class="form-floating"><input  type="number" min="0" class="form-control" name="required_hours" id="required_hours" placeholder=" " value="<?php echo htmlentities($row_rs['required_hours']); ?>"
          ...
          <div class="form-group">
                ...
                <div class="form-floating input-group">
                    ...
                    <a href="user_list.php" class="btn btn-outline-danger "><span class="bi-x-octagon"></span> Cancel</a>
  ...
  <input type="hidden" name="id" value="<?php echo htmlentities($row_rs['id']); ?>">
  <input type="hidden" name="prev_id" id="prev_id" value="<?php if (isset($_POST['prev_id']))echo $_POST['prev_id']; else echo htmlentities($row_rs['username']);?>">
  </fieldset>
  </div>
</form>
