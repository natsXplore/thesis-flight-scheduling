...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_aircraft (`aircraft_id`, `type_of_aircraft`, seat, color_marking, date_validity, endurance, crossing_speed, other_info) VALUES (?,?,?,?,?,?,?,?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="">Aircraft ID*</label>
          <input required type="text" class="form-control"  name="aircraft_id" id="aircraft_id" placeholder=" " value="<?php if (isset($_POST['aircraft_id'])) echo $_POST['aircraft_id'];?>" 
                  OnKeyUp="showAjax('aircraft_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('aircraft_duplicate.php','txtString',this.value, 'results_here');" >
        ...
        <label for="">Type of Aircraft*</label>
              <select required name="type_of_aircraft" id="type_of_aircraft" class="form-select" placeholder=" ">
                <?php
                  ...
                  ?>
                    <option value="<?php echo $row_rstype['type_of_aircraft']?>"><?php echo htmlentities($row_rstype['type_of_aircraft']);?></option>
                  <?php
                    }
                  ?>
                </select>
        ...
        <label for="">Seat*</label>
          <input required type="text" class="form-control"  name="seat" id="seat" placeholder=" " value="2">
        </div>

        <div class="form-group col-md-4 col-sm-12">
        <label for="">Color Marking*</label>
          <input required type="text" class="form-control"  name="color_marking" id="color_marking" placeholder=" " value="<?php echo htmlentities($rsbasic['set_aircraft_color_marking']);?>">
        </div>
        ...
        <div class="row">
          ...
          <input required type="text" class="form-control"  name="endurance" id="endurance" placeholder="HH:MM" value="">
        </div>
          <div class="form-group col-md-3 col-sm-12">
          <label for="">Date of Validity*</label>
            <input required type="date" class="form-control"  name="date_validity" id="date_validity" placeholder="" value="">
          </div>
       
          <div class="form-group col-md-3 col-sm-12">
            <label for="">Crossing Speed*</label>
            <input required type="text" class="form-control"  name="crossing_speed" id="crossing_speed" placeholder="" value="">
          </div>

          <div class="form-group col-md-3 col-sm-12">
            <label for="">Other Information</label>
            <input type="text" class="form-control"  name="other_info" id="other_info" placeholder="" value="">
          </div>
          </div>
          <br>
          <div class="row">
       ...
       <br>
        ...
        <div class="col-md-10">
          ...
          <a href="aircraft_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
