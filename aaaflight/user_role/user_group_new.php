...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <div class="form-group">
          <!-- Text input-->
            ...
            <label for="group" >Group</label>
              <input required type="text" class="form-control"  name="group" id="group" value="<?php if (isset($_POST['group'])) echo $_POST['group'];?>" 
                  OnKeyUp="showAjax('user_group_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('user_group_duplicate.php','txtString',this.value, 'results_here');" placeholder=" " >
        </div>
        <br>
        <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <a href="user_group_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
