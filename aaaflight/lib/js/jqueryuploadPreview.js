...
! function(e) {
    e.extend({
        uploadPreview1: function(l) {
            var i = e.extend({ input_field: ".image-input1", preview_box: ".image-preview1", label_field: ".image-label1", label_default: "Choose File", label_selected: "Change File", no_label: !1, success_callback: null }, l);
            return window.File && window.FileList && window.FileReader ? void(void 0 !== e(i.input_field) && null !== e(i.input_field) && e(i.input_field).change(function() {
                var l = this.files;
                if (l.length > 0) {
                    var a = l[0],
...
! function(e) {
    e.extend({
        uploadPreview2: function(l) {
            var i = e.extend({ input_field: ".image-input2", preview_box: ".image-preview2", label_field: ".image-label2", label_default: "Choose File", label_selected: "Change File", no_label: !1, success_callback: null }, l);
            return window.File && window.FileList && window.FileReader ? void(void 0 !== e(i.input_field) && null !== e(i.input_field) && e(i.input_field).change(function() {
                var l = this.files;
                if (l.length > 0) {
                    var a = l[0],
...
! function(e) {
    e.extend({
        uploadPreview3: function(l) {
            var i = e.extend({ input_field: ".image-input3", preview_box: ".image-preview3", label_field: ".image-label3", label_default: "Choose File", label_selected: "Change File", no_label: !1, success_callback: null }, l);
            return window.File && window.FileList && window.FileReader ? void(void 0 !== e(i.input_field) && null !== e(i.input_field) && e(i.input_field).change(function() {
                var l = this.files;
                if (l.length > 0) {
                    var a = l[0],
