...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_survival_equipment (`survival_equipment`) VALUES (?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="survival_equipment">Survival Equipment</label>
          <input required type="text" class="form-control"  name="survival_equipment" id="survival_equipment" placeholder=" " value="<?php if (isset($_POST['survival_equipment'])) echo $_POST['survival_equipment'];?>" 
                  OnKeyUp="showAjax('survival_equipment_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('survival_equipment_duplicate.php','txtString',this.value, 'results_here');" >
        ...
        <div class="col-md-10">
          ...
          <a href="survival_equipment_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
