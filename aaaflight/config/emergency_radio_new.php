...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_emergency_radio (`emergency_radio`) VALUES (?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="emergency_radio">Emergency Radio</label>
          <input required type="text" class="form-control"  name="emergency_radio" id="emergency_radio" placeholder=" " value="<?php if (isset($_POST['emergency_radio'])) echo $_POST['emergency_radio'];?>" 
                  OnKeyUp="showAjax('emergency_radio_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('emergency_radio_duplicate.php','txtString',this.value, 'results_here');" >
        ...
        <div class="col-md-10">
          ...
          <a href="emergency_radio_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
