...
$query_rs = "select * FROM `lup_wake_turbulance`";
$db->query($query_rs);
$rs=$db->rowset();
            ...
            <th>Description</th>
               <th data-sortable="false"  width="110px">
                <div class="btn-group" role="group" align="center">
                    <a href="wake_turbulance_new.php" class="btn btn-outline-secondary" data-toogle="tooltip" data-placement="bottom" title="New"><span class="bi-plus-square"></span> </a>
...
<?php foreach ($rs as $rs_data){ ?>
    <tr >
    <td class="align-middle"><?php echo htmlentities($rs_data['code']); ?></td>
    <td class="align-middle"><?php echo htmlentities($rs_data['description']); ?></td>
    <td  class="align-middle" width="110px">
        <div class="btn-group" role="group" align="center">
            <a href="wake_turbulance_update.php?recordID=<?php echo $rs_data['lup_wake_turbulance_id'];?>" class="btn btn-outline-success" data-toogle="tooltip" data-placement="bottom" title="Update"><span class="bi-pencil-square"></span></a>
            <a href='wake_turbulance_remove.php?recordID=<?php echo $rs_data["lup_wake_turbulance_id"];?>' class="btn btn-outline-danger" data-toogle="tooltip" data-placement="bottom" title="Remove"><span class="bi-trash"></span></a>
        </div>
    </td>
    </tr>
<?php } ?>
...
<div class="modal fade" id="modalDialogPrint" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body"><div id="printArea"><?php require('wake_turbulance_print.php'); ?></div></div>
