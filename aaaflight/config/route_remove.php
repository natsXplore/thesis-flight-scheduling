...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "DELETE FROM lup_route WHERE `lup_route_id` = ?";
    $db->query($SQLcrud);
...
<form id="form1" name="form1" method="post">
        ...
        <div class="form-group col-md-4 col-sm-12">
                ...
                <input readonly class="form-control" type="text" name="route_code" id="route_code"
        ...
        <div class="form-group col-md-8 col-sm-12">
                <label >Route*</label>
                <input readonly class="form-control" type="text" name="route" id="route"
        ...
        <div class="col-md-10">
          ...
          <a href="route_list.php" class="btn btn-outline-primary hidelink"><span class="bi-x-octagon"></span> No</a>
          </div>
        </div>
    ...
    <input type="hidden" name="id" id="id" value="<?php echo htmlentities($rs_data['lup_route_id']);?>">    
</form> 
