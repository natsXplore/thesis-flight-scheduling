...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_jacket (`jacket`) VALUES (?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="jacket">Jacket</label>
          <input required type="text" class="form-control"  name="jacket" id="jacket" placeholder=" " value="<?php if (isset($_POST['jacket'])) echo $_POST['jacket'];?>" 
                  OnKeyUp="showAjax('jacket_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('jacket_duplicate.php','txtString',this.value, 'results_here');" >
        ...
        <div class="col-md-10">
          ...
          <a href="jacket_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
