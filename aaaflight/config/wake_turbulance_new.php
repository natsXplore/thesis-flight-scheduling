...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_wake_turbulance (`code`, `description`) VALUES (?,?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="wake_turbulance">Code*</label>
          <input required type="text" class="form-control"  name="code" id="code" placeholder=" " value="<?php if (isset($_POST['code'])) echo $_POST['code'];?>" 
                  OnKeyUp="showAjax('wake_turbulance_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('wake_turbulance_duplicate.php','txtString',this.value, 'results_here');" >
          
        </div>
        <br>
        <div class="form-group col-md-8 col-sm-12">
        <label for="wake_turbulance">Description*</label>
        ...
        <div class="col-md-10">
          ...
          <a href="wake_turbulance_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
