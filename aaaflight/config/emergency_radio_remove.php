...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "DELETE FROM lup_emergency_radio WHERE `emergency_radio` = ?";
    $db->query($SQLcrud);
...
<form id="form1" name="form1" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label for="">Emergency Radio</label>
                <input name="emergency_radio" type="text" class="form-control input-md" readonly value="<?php echo htmlentities($rs_data['emergency_radio']); ?>"  placeholder=" ">
        ...
        <div class="col-md-10">
          ...
          <a href="emergency_radio_list.php" class="btn btn-outline-primary hidelink"><span class="bi-x-octagon"></span> No</a>
          </div>
        </div>
    ...
    <input type="hidden" name="id" id="id" value="<?php echo htmlentities($rs_data['emergency_radio']);?>">    
</form> 
