...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "DELETE FROM lup_jacket WHERE `jacket` = ?";
    $db->query($SQLcrud);
...
<form id="form1" name="form1" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input name="jacket" type="text" class="form-control input-md" readonly value="<?php echo htmlentities($rs_data['jacket']); ?>"  placeholder=" ">
        ...
        <div class="col-md-10">
          ...
          <a href="jacket_list.php" class="btn btn-outline-primary hidelink"><span class="bi-x-octagon"></span> No</a>
          </div>
        </div>
    ...
    <input type="hidden" name="id" id="id" value="<?php echo htmlentities($rs_data['jacket']);?>">    
</form> 
