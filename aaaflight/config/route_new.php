...
if ((isset($_POST["POSTcheck"])) && ($_POST["POSTcheck"] == "form1")) {
    ...
    $SQLcrud = "INSERT INTO lup_route (`route_code`, `route`) VALUES (?,?)";
    $db->query($SQLcrud);
...
<form method="post" name="form1" id="form1" onsubmit="return validateForm();">
     ...
     <div class="form-horizontal">
        ...
        <label for="route">Route Code*</label>
          <input required type="text" class="form-control"  name="route_code" id="route_code" placeholder=" " value="<?php if (isset($_POST['route_code'])) echo $_POST['route_code'];?>" 
                  OnKeyUp="showAjax('route_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('route_duplicate.php','txtString',this.value, 'results_here');" >
          
        </div>
        <br>
        <div class="form-group col-md-8 col-sm-12">
        <label for="route">Route*</label>
          <input required type="text" class="form-control"  name="route" id="route" placeholder=" " value="<?php if (isset($_POST['route'])) echo $_POST['route'];?>">
        </div>
        </div>
        <br>
        ...
        <div class="col-md-10">
          ...
          <a href="route_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
