     ...
     <div class="form-horizontal">
        ...
        <label for="designation">Designation</label>
          <input required type="text" class="form-control"  name="designation" id="designation" placeholder=" " value="<?php if (isset($_POST['designation'])) echo $_POST['designation'];?>" 
                  OnKeyUp="showAjax('designation_duplicate.php','txtString',this.value, 'results_here');" Onblur="showAjax('designation_duplicate.php','txtString',this.value, 'results_here');" >
        ...
        <div class="col-md-10">
          ...
          <a href="designation_list.php" class="btn btn-outline-danger hidelink"><span class="bi-x-octagon"></span> Cancel</a> 
          </div>
        </div>
